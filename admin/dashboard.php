...
<body class="admin-body">
    ...
    <main class="admin-main">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <div class="stat-icon" style="background: linear-gradient(135deg, #d4af37 0%, #b8941f 100%);">👥</div>
            ...
            <div class="stat-card">
                <div class="stat-icon" style="background: linear-gradient(135deg, #c4a040 0%, #a68825 100%);">📝</div>
                <div class="stat-content">
